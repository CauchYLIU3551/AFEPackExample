 ...
 *
 * @brief  This is an example of Laplacian eigenvalue problem solver.
 *
 */
  ...
  do {
    ...
    for (;the_ele != end_ele;++ the_ele) {
      ...
      for (u_int l = 0;l < n_q_pnt;++ l) {
        ...
        for (u_int i = 0;i < n_ele_dof;++ i) {
	  //
	  // I can edit here to change the right hand side into a matrix form, Then I will store the Mass Matrix into it.
